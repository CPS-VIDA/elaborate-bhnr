...
def lti_filter_monitor(phi: stl.Expression, w: pd.DataFrame, time_stamps: list or tuple or np.ndarray = None, dt: float = -1.0,  window: str or tuple or float = 'boxcar'):
    """
